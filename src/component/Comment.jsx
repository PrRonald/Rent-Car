                    ...
                    <div >
                        <div className="w-full grid grid-cols-2  justify-between" >
                            <div>
                                ...
                                <h2 
                                    className="font-medium bold text-[12px] leading-[15.12px] text-[#90A3BF] " >
                                    {elem.carrer}
                                </h2>
                            </div>
                            <div className="flex flex-col items-end justify-center"  >
                                <h2 
                                    className="font-medium text-[12px] leading-[15.12px] text-[#90A3BF] " >
                                    {elem.date}
                                </h2>
                        ...
                        <div>
                            <p 
                                className=" font-normal text-[12px] leading-[24px] text-[#90A3BF] mt-4 mb-4 ">
                                {elem.comment}
                            </p>
                        </div>
                    </div>
